-- Parche: redeem ACT con fallback de comprador_email (teléfono WhatsApp del salón)
-- Ejecutar en Supabase → SQL Editor si la activación web falla con:
-- null value in column "comprador_email" of relation "gift_cards"
